#define forcePin1 A3       // load cell 1 pin (pin 17)
#define forcePin2 A0       // load cell 2 pin (pin 14)
#define flexPin1 A2        // flex sensor 1 pin (pin 16)
#define flexPin2 A1        // flex sensor 2 pin (pin 15)
